  ...
  program
    ...
    .action(async (options) => {
      ...
      try {
        ...
        const suggestions = [
          { description: 'See which files drive the most cost', command: 'specter hotspots' },
          { description: 'Get AI refactoring suggestions', command: 'specter suggest-refactor' },
          { description: 'Track cost trends over time', command: 'specter trends' },
        ]
